...
const StudentCard: React.FC<StudentCardProps> = ({ student, onClick, isRemoveMode, onRemoveFromClass }) => {
  ...
  return (
    <div
        className={`relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 transition-all duration-200 group ${
            isRemoveMode ? 'cursor-pointer animate-wobble' : 'cursor-grab hover:shadow-lg hover:border-blue-500 dark:hover:border-blue-400'
        }`}
    >
